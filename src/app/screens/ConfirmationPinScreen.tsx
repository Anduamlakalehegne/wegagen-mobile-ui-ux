      ...
      >
        <div className="px-8 py-10 flex flex-col items-center h-full">
          ...
          <div className="mb-8 text-center px-4 font-sans">
            <h1 className="text-[#004360] text-[26px] font-semibold tracking-tight leading-tight mb-2">
              Confirm Pin
            </h1>
            <p className="text-[#004360]/60 text-[13px] font-medium leading-relaxed opacity-80">
              Enter transaction pin to authorize transfer
            </p>
          </div>

          {/* PIN Dots (Identical to Entry Screen) */}
          ...
          {/* Numeric Keypad (Identical to Entry Screen) */}
